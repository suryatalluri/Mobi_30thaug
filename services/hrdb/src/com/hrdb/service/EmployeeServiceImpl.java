...
public class EmployeeServiceImpl implements EmployeeService {
    ...
    @Transactional(readOnly = true, value = "hrdbTransactionManager")
    @Override
    public Page<Employee> findAssociatedEmployeesForManagerId(int empId, Pageable pageable) {
    ...
    @Transactional(readOnly = true, value = "hrdbTransactionManager")
    @Override
    public Page<Vacation> findAssociatedVacations(int empId, Pageable pageable) {
