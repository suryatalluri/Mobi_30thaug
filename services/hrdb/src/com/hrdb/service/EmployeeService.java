...
public interface EmployeeService {
    ...
    /*
     * Returns associate employeeByManagerId for given Employee id.
     *
     * @param empId empId value
     * @return Associate Employee instances.
     */
    Page<Employee> findAssociatedEmployeesForManagerId(int empId, Pageable pageable);

    /*
     * Returns associate employee for given Employee id.
     *
     * @param empId empId value
     * @return Associate Vacation instances.
     */
    Page<Vacation> findAssociatedVacations(int empId, Pageable pageable);
